...
}:
{
  ...
  bingimg = {
    pname = "bingimg";
    version = "MouseholeXmas_JA-JP0779815955";
    src = fetchurl {
      url = "https://www.bing.com/th?id=OHR.MouseholeXmas_JA-JP0779815955_UHD.jpg";
  ...
  metacubexd = {
    ...
    version = "v1.176.0";
    src = fetchurl {
      url = "https://github.com/MetaCubeX/metacubexd/releases/download/v1.176.0/compressed-dist.tgz";
      sha256 = "sha256-M7ISDdnZre/ppBx7Kd/KeK6vEJPkXs4nshVRAx/shaA=";
    };
  };
  mhutchie_git-graph = {
  ...
  nezha-agent = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.4.0";
      fetchSubmodules = false;
      sha256 = "sha256-f3GHxNw0vJXYsxe/UCzyyCRQldmsDq3Ur8kwskEA6Z4=";
    };
  };
  nezha-dashboard = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.4.5";
      fetchSubmodules = false;
      sha256 = "sha256-hV5qZtuA1/BqMQfQHmjLcKAVz31fxhxDyLsMKzcN0U4=";
    };
  };
  nezha-theme-admin = {
    ...
    version = "v1.4.3";
    src = fetchurl {
      url = "https://github.com/nezhahq/admin-frontend/releases/download/v1.4.3/dist.zip";
      sha256 = "sha256-MkKzcUpkLQPb1Sh0i3X3SjQ3cuac/BixKawUfjTZYaA=";
    };
  };
  nezha-theme-user = {
  ...
  rust-lang_rust-analyzer = {
    ...
    version = "0.4.2231";
    src = fetchurl {
      url = "https://rust-lang.gallery.vsassets.io/_apis/public/gallery/publisher/rust-lang/extension/rust-analyzer/0.4.2231/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "rust-analyzer-0.4.2231.zip";
      sha256 = "sha256-g090cJDrFQcs1doJTjP3Y9CEj3wQE7zOlZiBoKNmVZY=";
    };
  };
  staticcheck = {
    pname = "staticcheck";
